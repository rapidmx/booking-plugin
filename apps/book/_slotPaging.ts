 ...
 */
import { BookingSlot, getBookingSlots } from "../shared/bookingApi.js";

/** `BaseBookingRoute`'s `MAX_SLOTS_PER_RESPONSE`: a response this long was cut off, and its window has more slots. */
export const MAX_SLOTS_PER_RESPONSE = 500;
/** Days of availability asked for per request - the route's own default window, which bounds its per-request work. */
