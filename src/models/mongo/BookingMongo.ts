...
/**
 * Implementation of the `Booking` interface for storage in a MongoDB database. If SQL is desired, please use
 * `models.sql.BookingSQL` instead.
 *
...
export class BookingMongo extends BaseMongoEntity implements Booking {
    @Column()
    ...
    constructor(other?: Partial<BookingMongo>) {
        super(other);
