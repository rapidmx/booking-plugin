...
/**
 * Implementation of the `BookingType` interface for storage in a MongoDB database. If SQL is desired, please
 * use `models.sql.BookingTypeSQL` instead.
 *
...
export class BookingTypeMongo extends BaseMongoEntity implements BookingType {
    @Column()
    ...
    constructor(other?: Partial<BookingTypeMongo>) {
        super(other);
